<template>
    <div class="box">
        <div class="main">
            <div class="left">
                <img src="../assets/images/QQ图片20220925112913.jpg" alt="">
                <h3 style="margin-top:20px;">古风音乐</h3>
                <p style="margin-top:15px;">古风歌曲是以传统民族元素（古典文学意象、民族乐器、五声音阶等）为基底所创造的流行歌曲。随着古风的商业化慢慢的出现了国风一词，于是凡带有中国传统文化元素的音乐，渐渐都被统称为国风音乐。</p>
            </div>
...
export default {
    ...
    setup() {
        ...
        store.dispatch('searchddd/setserachsong', '国风')
